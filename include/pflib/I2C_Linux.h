...
/**
 * @class I2C
 * @brief Base class which encapsulates the I2C interface, represents a single bus
 */
class I2C_Linux : public I2C {
 public:
  ...
  /** 
   * Carry out a write of zero or more bytes followed a by a read of zero or more bytes.  If either write or read is zero bytes long, it is omitted.
