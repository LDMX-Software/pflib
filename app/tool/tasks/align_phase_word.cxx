...
void align_phase_word(Target* tgt) {
  ...
  // // {  // set run value   // THIS is not necessary; it doesnt seem to do
  // anything. Just setting the inversion bit is enough to get the run bit to
  // flip to 8. HOWEVER the inversion bit, when read, still says 0. auto
  // econ_setup_builder =
