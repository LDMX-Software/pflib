 ...
 * Scans over phase_ck and prints values. Optimal phase_ck is when pedestal adc
 * is at a maximum. Scans over phase_strobe and prints values. charge_to_l1a
 * should be placed at the phase_strobe and bx where adc is at a maximum.
 */
