 ...
 * TASKS.SET_TOA
 *
 * Do a charge injection run for a given channel, find the toa efficiency, and
 * set the toa threshold to the first point where the toa efficiency is 1. This
 * corresponds to a point above the pedestal where the pedestal shouldn't
