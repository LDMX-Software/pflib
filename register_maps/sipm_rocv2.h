...
const Page GLOBAL_ANALOG_LUT =
    Page::Mapping({{"ON_DAC_TRIM", Parameter(0, 0, 1, 1)},
...
const Page REFERENCE_VOLTAGE_LUT = Page::Mapping(
    {{"PROBE_VREF_PA", Parameter(0, 0, 1, 0)},
     ...
     {"NOINV_VREF",
      Parameter({RegisterLocation(1, 0, 2), RegisterLocation(5, 0, 8)},
                0b0100111100)},
     {"INV_VREF",
      Parameter({RegisterLocation(1, 2, 2), RegisterLocation(4, 0, 8)},
                0b0110000000)},
     {"TOA_VREF",
      Parameter({RegisterLocation(1, 4, 2), RegisterLocation(3, 0, 8)},
                0b0001110000)},
     {"TOT_VREF",
      Parameter({RegisterLocation(1, 6, 2), RegisterLocation(2, 0, 8)},
                0b0110110000)},
     {"CALIB_DAC",
      Parameter({RegisterLocation(6, 0, 8), RegisterLocation(7, 0, 4)}, 0)},
...
const Page MASTER_TDC_LUT = Page::Mapping(
    {{"GLOBAL_TA_SELECT_GAIN_TOA", Parameter(0, 0, 4, 0b0011)},
     ...
     {"BIAS_CAL_DAC_CTDC_P_D",
      Parameter({RegisterLocation(4, 0, 2), RegisterLocation(7, 6, 2)},
                0b0000)},
     ...
     {"BIAS_CAL_DAC_FTDC_P_D",
      Parameter({RegisterLocation(10, 0, 2), RegisterLocation(14, 6, 2)},
                0b0000)},
...
const Page CHANNEL_WISE_LUT = Page::Mapping(
    {{"INPUTDAC", Parameter(0, 0, 6, 0b011111)},
     {"DACB", Parameter({RegisterLocation(2, 6, 2), RegisterLocation(1, 6, 2),
                         RegisterLocation(0, 6, 2)},
                        0b111111)},
     ...
     {"EXTDATA",
      Parameter({RegisterLocation(13, 0, 8), RegisterLocation(11, 0, 2)}, 0)},
...
const Page DIGITAL_HALF_LUT = Page::Mapping(
    {{"SELRAWDATA", Parameter(0, 0, 1, 1)},
     ...
     {"L1OFFSET",
      Parameter({RegisterLocation(2, 0, 8), RegisterLocation(1, 7, 1)},
                0b000001000)},
     {"IDLEFRAME",
      Parameter({RegisterLocation(3, 0, 8), RegisterLocation(4, 0, 8),
                 RegisterLocation(5, 0, 8), RegisterLocation(6, 0, 4)},
                0b1100110011001100110011001100)},
 ...
 */
const Page TOP_LUT =
    Page::Mapping({{"EN_LOCK_CONTROL", Parameter(0, 0, 1, 1)},
...
const PageLUT PAGE_LUT =
    PageLUT::Mapping({{"GLOBAL_ANALOG", GLOBAL_ANALOG_LUT},
