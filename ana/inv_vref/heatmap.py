...
axes[0].set_xlabel(r'noinv_{vref}')
...
axes[1][0].set_xlabel(r'inv_{vref}')
axes[1][0].set_xlabel(r'inv_{vref}')
...
for ch_id, ch_df in channels:
    ...
    plt.colorbar().set_label(label='Median pedestal ADC [a.u.]',size=14)
    plt.xlabel(r"inv$_{\text{vref}}$", fontsize=14)
    plt.ylabel(r"noinv$_{\text{vref}}$", fontsize=14)
