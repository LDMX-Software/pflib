...
namespace pflib {
  ...
  std::vector<uint32_t> ECOND_Formatter::format_elink(int ielink, const std::vector<uint32_t>& src) {
	...
	while (insert_len>=space_left) {
	  ...
	  if ((insert_len-space_left)==8) insert_value&=0xFF;
	  else if ((insert_len-space_left)==16) insert_value&=0xFFFF;
	  else if ((insert_len-space_left)==24) insert_value&=0xFFFFFF;
  ...
  static const uint32_t data[]={0xf00c9c86u,0x2012c02,
    0x0c601803,0x08f07d02,0x08509602,0x0840d702,
    0x0c705d03,0x0c303d03,0x08f0ff02,
    0x0c906d03,0x0c203d03,0x0c200c03,0x0ca06503,
    0x0c609a03,0x0ce02c03,0x0c304903,0x0c308e03,
    0x0c108e03,0x0c508e03,0x0ce03c03,0x0c705d03,
    0x0cf03c03,0x0c902403,0x0cf07d03,0x0cf03c03,
    0x0cf07d03,0x0c409603,0x0c50d303,0x0ca0aa03,
