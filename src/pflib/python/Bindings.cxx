...
BOOST_PYTHON_MODULE(pflib_python) {
  ...
  bp::class_<pflib::Hcal>("Hcal",bp::init<pflib::WishboneInterface*>())
    ...
    .def("elinks", &pflib::Hcal::elinks, bp::return_internal_reference<>())
    .def("fc", &pflib::Hcal::fc, bp::return_internal_reference<>())
    .def("getFirmwareVersion", &pflib::Hcal::getFirmwareVersion)
