...
void Bias::initialize() {
  // Reset all DAC:s
  i2c_board_->general_write_read(0x10, {0x35, 0x96, 0x30}, 0);
  i2c_board_->general_write_read(0x12, {0x35, 0x96, 0x30}, 0);
  i2c_board_->general_write_read(0x14, {0x35, 0x96, 0x30}, 0);
  i2c_board_->general_write_read(0x18, {0x35, 0x96, 0x30}, 0);

  // Set internal ref on DAC to 4.096 V
  i2c_board_->general_write_read(0x10, {0x27, 0x00, 0x00}, 0);
  i2c_board_->general_write_read(0x12, {0x27, 0x00, 0x00}, 0);
  i2c_board_->general_write_read(0x14, {0x27, 0x00, 0x00}, 0);
  i2c_board_->general_write_read(0x18, {0x27, 0x00, 0x00}, 0);
