 ...
 *
 * We do the naive algorithm, calculating the slope of all pairs of sample points
 * and then finding the median of that slope. The final intercept is the median
 * of the intercepts from all points using the median slope.
 *
...
trim_toa_scan(Target* tgt, ROC roc) {
  ...
  // 72 channels, 200 calib values, 8 trim_toa values. Only store toa_efficiency here.
